...
[VB-CABLE](https://vb-audio.com/Cable/) is the supported virtual cable for this workflow. It is a third-party Windows driver and is **not bundled with AudioManager**.

1. Download VB-CABLE from the official VB-Audio website.
2. Extract the package and run its setup program as an administrator.
3. Restart Windows after installation.
4. Re-open AudioManager and select the new cable endpoints.

> AudioManager detects compatible virtual cable endpoints, but it does not install, redistribute, repair, or manage VB-CABLE. Follow VB-Audio's licence and installation guidance for the driver.
